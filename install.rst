...
2. Read license agreement. You must accept the terms of the agreement before continuing with the installation.

3. Choose folder where Modem Manager will be installed to. Modem Manager installs some additional files like localization and help files.
...
6. Uncheck "Create a desktop icon" if you don't want it to be created.

7. Check if everything matches your needs and click Install button to begin the installation.

8. Uncheck "Launch Technikon Modem Manager" if you don't want it to launch right away. Finish the installation.
